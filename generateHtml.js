...
function Shell() {
  return (
    <Router>
      <div className="py-5 my-5 text-center"></div>
    </Router>
  )
}
...
function html(x) {
  ...
  <html lang="en">
    <head>
      ...
      <script async src="https://www.googletagmanager.com/gtag/js?id=UA-176102785-1"></script>
      <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());
        gtag('config', 'UA-176102785-1');
      </script>
